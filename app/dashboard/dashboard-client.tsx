...
export function DashboardClient({ data }: { data: Data }) {
  ...
  const save = async (event: FormEvent<HTMLFormElement>) => {
    ...
    else body = { image: await uploadSelectedFile(form, 'imageFile', 'image', event.currentTarget), caption: form.get('caption') };
